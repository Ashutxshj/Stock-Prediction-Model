...
def df_to_windowed_df(dataframe, first_date_str, last_date_str, n=3):
    ...
    # Function to convert windowed dataframe to X and y
...
# Convert windowed dataframe to X and y
...
st.write('Mean Absolute Percentage Error (MAPE) for Train Data:', mape_train)
st.write('Mean Absolute Percentage Error (MAPE) for Test Data:', mape_test)
